            ...
            <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <textarea class="form-control" name="small_description_ku"></textarea>
                    </div>

                    <div class="col-md-2 mb-4">
                        <label class="form-label">EA/CA</label>
                        <input type="number" class="form-control" name="ea_ca" required>
                    </div>

                    <div class="col-md-2 mb-4">
                        <label class="form-label">EA/PA</label>
                        <input type="number" class="form-control" name="ea_pa" required>
                    </div>
                ...
                <hr>
                <h5>B2B Price</h5>
                @include('cms.partials.price_fields', ['prefix' => 'b2b'])

                <hr>
                <h5>B2C Price</h5>
                @include('cms.partials.price_fields', ['prefix' => 'b2c'])
