            ...
            <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <input type="text" class="form-control" name="name_ku" value="{{ old('name_ku', $product->name_ku) }}" required>
                    </div>

                    <div class="col-md-4 mb-4">
                        <label class="form-label">Small Description (English)</label>
                        <textarea class="form-control" name="small_description_en">{{ old('small_description_en', $product->small_description_en) }}</textarea>
                    </div>

                    <div class="col-md-4 mb-4">
                        <label class="form-label">Small Description (Arabic)</label>
                        <textarea class="form-control" name="small_description_ar">{{ old('small_description_ar', $product->small_description_ar) }}</textarea>
                    </div>

                    <div class="col-md-4 mb-4">
                        <label class="form-label">Small Description (Kurdish)</label>
                        <textarea class="form-control" name="small_description_ku">{{ old('small_description_ku', $product->small_description_ku) }}</textarea>
                    </div>

                    <div class="col-md-2 mb-4">
                        <label class="form-label">EA/CA</label>
                        <input type="number" class="form-control" name="ea_ca" value="{{ old('ea_ca', $product->ea_ca) }}" required>
                    </div>

                    <div class="col-md-2 mb-4">
                        <label class="form-label">EA/PA</label>
                        <input type="number" class="form-control" name="ea_pa" value="{{ old('ea_pa', $product->ea_pa) }}" required>
                    </div>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="subcategories_id" class="form-select select2" required>
                            ...
                            <option value="{{ $subcategory->id }}" {{ old('subcategories_id', $product->subcategories_id) == $subcategory->id ? 'selected' : '' }}>
                                {{ $subcategory->name_en }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="brands_id" class="form-select select2" required>
                            ...
                            <option value="{{ $brand->id }}" {{ old('brands_id', $product->brands_id) == $brand->id ? 'selected' : '' }}>
                                {{ $brand->name_en }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-4 mb-4">
                        ...
                        <select name="tax_id" class="form-select select2">
                            ...
                            <option value="{{ $tax->id }}" data-rate="{{ $tax->rate }}" {{ old('tax_id', $product->tax_id) == $tax->id ? 'selected' : '' }}>
                                {{ $tax->name }} ({{ $tax->rate }}%)
                            </option>
                            @endforeach
                        </select>
