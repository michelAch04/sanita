        ...
        <div class="card-body">
            <form action="{{ route('subcategories.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="input-container mb-5 mt-3" style="width: 30%;">
                    <input type="text" id="name_en" name="name_en" value="{{ old('name_en') }}" required style="width: 100%;">
                ...
                {{-- Subcategory Name --}}
                <div class="input-container mb-5 mt-3" style="width: 30%;">
                    <input type="text" id="name_ar" name="name_ar" value="{{ old('name_ar') }}" required style="width: 100%;">
                ...
                {{-- Subcategory Name --}}
                <div class="input-container mb-5 mt-3" style="width: 30%;">
                    <input type="text" id="name_ku" name="name_ku" value="{{ old('name_ku') }}" required style="width: 100%;">
                    <label for="name_ku" class="label">Subcategory Name (Arabic)</label>
                    <div class="underline"></div>
                </div>
