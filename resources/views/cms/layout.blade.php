...
<head>
    ...
    <link href="{{ asset('css/ui-tools.css?v=20260306-3') }}" rel="stylesheet" />
    <link href="{{ asset('css/view-styles.css?v=20260306-3') }}" rel="stylesheet" />
...
<body style="overflow-x: hidden !important;">
    ...
    <script src="{{ asset('js/ajax-live-search.js?v=20260306-3') }}"></script>
    <script src="{{ asset('js/file-input.js?v=20260306-3') }}"></script>
