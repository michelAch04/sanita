...
<div class="d-flex justify-content-center w-100 mb-3">
    <form class="search-form d-flex align-items-center w-50" action="{{ route('tax.index') }}" method="GET">
        <input type="text" name="query" class="form-control me-2 search-input rounded-pill shadow-soft" placeholder="Search taxes..." autocomplete="off">
    </form>
</div>
