...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ui-tools.css') }}?v=20260302-2">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}?v=20260302-2">
    <link rel="stylesheet" href="{{ asset('css/auth.css') }}?v=20260302-2">
    <link rel="stylesheet" href="{{ asset('css/mobile.css') }}?v=20260302-2">
</head>
