...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ui-tools.css') }}?v=20260306-2">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}?v=20260306-2">
    <link rel="stylesheet" href="{{ asset('css/auth.css') }}?v=20260306-2">
    <link rel="stylesheet" href="{{ asset('css/mobile.css') }}?v=20260306-2">
</head>
...
<!-- Laravel Assets -->
<script src="{{ asset('js/app.js?v=20260306-2') }}"></script>
<script src="{{ asset('js/modals.js?v=20260306-2') }}"></script>
<script src="{{ asset('js/promocode.js?v=20260306-2') }}"></script>
