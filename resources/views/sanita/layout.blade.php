...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/ui-tools.css') }}?v=20260306-3">
    <link rel="stylesheet" href="{{ asset('css/app.css') }}?v=20260306-3">
    <link rel="stylesheet" href="{{ asset('css/auth.css') }}?v=20260306-3">
    <link rel="stylesheet" href="{{ asset('css/mobile.css') }}?v=20260306-3">
</head>
...
<script type="module" src="https://cdnjs.cloudflare.com/ajax/libs/intl-tel-input/25.3.1/build/js/i18n/ar/index.min.js"></script>

<!-- Laravel Assets -->
<script src="{{ asset('js/app.js?v=20260306-3') }}"></script>
<script src="{{ asset('js/modals.js?v=20260306-3') }}"></script>
<script src="{{ asset('js/promocode.js?v=20260306-3') }}"></script>
