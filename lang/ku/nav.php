...
return [
    ...
    'pos_no_locations' => 'هیچ شوێنیەک بەردەست نییە هێشتا.',
    ...
    'cart_add_failed' => 'زیادکردن بۆ سەبەتەکە سەرنەکەوت.',
    'cart_add_error' => 'هەڵە ڕووی دا کاتێک بۆ سەبەتەکە زیاددەکرێت.',
    'invalid_mobile' => 'ژمارەی مۆبایل نادروستە',
    'invalid_date' => 'ڕێکەوت نادروستە',
];
